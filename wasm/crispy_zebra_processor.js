const EXP = {
  ...
  set_dca_curve_mode: "U", get_max_voice_count: "V",
  set_line1_wave1: "W", set_line1_wave2: "X",
  set_line2_wave1: "Y", set_line2_wave2: "Z",
  set_eg_rate: "_", set_eg_level: "$",
  set_eg_sustain_point: "aa", set_eg_end_point: "ba",
  set_dco_eg_attack: "ca", set_dco_eg_decay1: "da",
  set_dco_eg_decay2: "ea", set_dco_eg_release: "fa",
  set_dcw_eg_attack: "ga",
  set_dcw_eg_decay1: "ha", set_dcw_eg_decay2: "ia",
  set_dcw_eg_release: "ja",
  set_dca_eg_attack: "ka", set_dca_eg_decay1: "la",
  set_dca_eg_decay2: "ma", set_dca_eg_release: "na",
  debug_envelope_state: "oa", debug_active_voices: "pa",
  debug_dca_level: "qa", debug_dca_end_point: "ra",
  debug_dca_sustain_point: "sa", debug_dca_rate: "ta",
  debug_dca_level_stage: "ua", set_mono_mode: "va"
};
